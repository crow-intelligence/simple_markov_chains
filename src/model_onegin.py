...
with open("data/clean/onegin.txt", "r") as infile:
    onegin = infile.read().split("\n")
...
with open("models/tokens_onegin.pkl", "wb") as outfile:
    pickle.dump(token_rel_freq, outfile)

with open("models/bigrams_onegin.pkl", "wb") as outfile:
    pickle.dump(bigram_rel_freq, outfile)

with open("models/trigrams_onegin.pkl", "wb") as outfile:
    pickle.dump(trigram_rel_freq, outfile)

with open("models/fourgrams_onegin.pkl", "wb") as outfile:
